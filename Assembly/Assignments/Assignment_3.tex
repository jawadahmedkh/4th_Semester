...
\begin{center}
    ...
    { \bfseries Assignment No 3} \\[0.5cm]
...
\begin{titlepage}
    ...
    \vspace*{2cm}
    {\Huge \textbf{Assignment Title}} \\[0.5cm]
    {\Large \itshape Writing a Program in Assembly Language} \\[2cm]
...
\begin{terminal}
    C:/Users/Jawad> program.exe\\
    Hello, this is my Assembly Program!
\end{terminal}
